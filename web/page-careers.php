...
<section id="pageWrapper" class="container careers flyoutPage">
...
<?php else : // load only the content for AJAX ?>
	<div id="content" class="careers flyoutPage" data-title="<?php echo get_ajax_title(); ?>">
